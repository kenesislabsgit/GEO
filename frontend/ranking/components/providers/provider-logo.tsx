...
/**
 * Provider marks, drawn inline so they inherit currentColor and need no
 * network. Paths from simple-icons (CC0); Nova has no published mark, so it
 * gets a plain four-point star.
 */
...
const ICON_BY_PROVIDER: Record<string, string> = {
  openai: "openai",
...
/** Logo + display name, inline. The standard way a provider is named in UI. */
export function ProviderBadge({
  ...
  provider: string;
  /** Override the display name (e.g. the customer-facing "ChatGPT"). */
  label?: string;
  className?: string;
}) {
  return (
