...
const CARD_FEATURES: Partial<Record<PlanId, CardFeature[]>> = {
  founder: [
    ...
    { text: "20 questions × 5 AIs × 1 answer = 100 checks per audit" },
    {
    ...
    { text: "Public sharing, with private-report controls in Website settings" },
  ],
  agency: [
  ...
  return (
    <div>
      ...
      <div className="mt-6 text-center">
        ...
        <p className="mt-2 text-xs text-muted-foreground">No card required. Free reports are public and shareable; search engines may index them.</p>
