...
export function AuditCompleteBanner() {
  ...
  return (
    <div className="mb-6 flex items-start justify-between gap-3 rounded-lg border border-[color:var(--arc-accent)]/30 bg-[color:var(--arc-accent-soft)] px-4 py-3 text-sm">
      <div className="flex gap-2.5">
        <CheckCircle2 className="mt-0.5 size-4 shrink-0 text-[color:var(--arc-accent)]" aria-hidden />
        <div>
