...
const timelines = [
  {
    plan: "Free",
    ready: "First results after one audit",
    body: `${FREE_AUDIT_QUESTION_COUNT} questions, one provider. One run per website every ${FREE_SCAN_CACHE_DAYS} days. No scheduled monitoring. Results are saved in the dashboard.`,
  },
  {
    plan: "Plus",
    ...
    <MarketingShell narrow>
      <section className="border-b border-border pb-14 md:pb-20">
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
          ...
          customer-side integration work before the first audit.
        </p>
      </section>
