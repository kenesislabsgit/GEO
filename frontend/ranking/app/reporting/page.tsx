...
export const metadata = {
  ...
  description:
    "How Arcanoris schedules re-scans, emails visibility alerts, keeps audit history, and exports CSV on Pro.",
...
const frequencies = [
  {
    ...
    cadence: "Manual only",
    detail:
      "One audit per website every 30 days. There is no scheduled re-scan and no email alert. Results remain in the dashboard.",
  },
  {
    plan: "Plus",
    cadence: "Weekly",
    ...
    <MarketingShell narrow>
      <section className="border-b border-border pb-14 md:pb-20">
        ...
        <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
          Scheduled re-scans, email alerts, saved history, and Pro CSV
      ...
      <section className="border-b border-border py-14">
        <h2 className="font-heading text-2xl font-semibold tracking-tight">
          What a scheduled audit contains
        </h2>
        <p className="mt-3 leading-relaxed text-muted-foreground">
      ...
      <section className="py-14">
        ...
        <ol className="mt-4 list-decimal space-y-2 pl-5 text-sm leading-relaxed text-muted-foreground">
          ...
          <li>CSV export returns an upgrade message on Free and Plus.</li>
        </ol>
