  ...
  return (
    <MarketingShell>
      <div className="grid items-start gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
        <div>
          <p className="arc-eyebrow">Sales</p>
          <h1 className="font-heading mt-3 text-4xl font-semibold tracking-tight md:text-5xl">
            Contact our sales team
          </h1>
          <p className="mt-4 max-w-md text-lg text-muted-foreground">
            Get started with {APP_NAME} Pro: multi-website AI visibility,
            the full provider set, and a plan we set up with you.
          </p>
          <div className="mt-10">
            <p className="text-sm font-medium">What Pro includes</p>
