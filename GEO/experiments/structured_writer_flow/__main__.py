...
from .flow import StructuredWriterFlow, default_output_dir


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the isolated evidence-first writer experiment.")
